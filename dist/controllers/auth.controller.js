...
const initiateAdmin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Check in user data / entry is exist
        const count = yield user_model_1.default.countDocuments({});
        if (count > 0) {
            res.status(400).json({ message: "We can only have 1 admin user if you want to create new admin user, please delete the user manual from the database" });
            return;
        }
